<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" class="user-breadcrumb">
      ...
      <el-breadcrumb-item>详情页PV/UV统计</el-breadcrumb-item>
    ...
    <el-card>
      ...
      <div >
        <!-- 数据的表格展示-->
        <detail-page-click-table :pvlist="tablePvList" :uvlist="tableUvList" class="top-margin30"/>
        <detail-page-click-p-v-pie :pvlist="pvPieList" class="top-margin15"/>
        <detail-page-click-u-v-pie :uvlist="uvPieList" class="top-margin15"/>
...
<script>
  import DetailPageClickTable from "./detailpagechild/DetailPageClickTable";
  import DetailPageClickPVPie from "./detailpagechild/DetailPageClickPVPie";
  import DetailPageClickUVPie from "./detailpagechild/DetailPageClickUVPie";
  export default {
    name: "DetailPageClick",
    components:{DetailPageClickTable,DetailPageClickPVPie,DetailPageClickUVPie},
    data() {
      return {
        query: {
          page: 1,
    ...
    methods: {
      ...
      async getDataList() {
        const res = await this.$http.get(`/hbydGame/gameDetail/getListDayCountPvUv?page=${this.query.page}&limit=${this.query.limit}`)
