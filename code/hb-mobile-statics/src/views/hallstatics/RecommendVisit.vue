<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" class="user-breadcrumb">
      ...
      <el-breadcrumb-item>推荐位访问统计</el-breadcrumb-item>
...
<script>
  export default {
    ...
    methods: {
      ...
      async getDataList() {
        const res = await this.$http.get(`/hbydGame/recommendGame/getListByPage?page=${this.query.page}&limit=${this.query.limit}`)
