<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" class="user-breadcrumb">
      ...
      <el-breadcrumb-item>轮播位访问统计</el-breadcrumb-item>
    ...
    <el-card>
      <el-row>
        ...
        <el-col :span="4">
          <span>类型:</span>
          <el-select class="left-margin15" v-model="query.type" placeholder="时间" @change="optionChange">
            <el-option
                v-for="item in types"
                :key="item.value"
                :label="item.label"
...
<script>
  export default {
    ...
    methods: {
      ...
      async getDataList() {
        const res = await this.$http.get(`/hbydGame/activityGame/getListByPage?page=${this.query.page}&limit=${this.query.limit}`)
