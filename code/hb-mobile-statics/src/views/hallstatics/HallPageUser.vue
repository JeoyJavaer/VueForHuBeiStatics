<template>
  ...
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" class="user-breadcrumb">
      ...
      <el-breadcrumb-item>大厅PV/UV统计</el-breadcrumb-item>
    ...
    <el-card>
      ...
      <div >
        <!-- 数据的表格展示-->
        <hall-page-click-table :pvlist="tablePvList" :uvlist="tableUvList" :orderlist="tableOrderList" :ratelist="tableRateList" class="top-margin30"/>
        <hall-page-click-p-v-pie :pvlist="pvPieList" class="top-margin15"/>
        <hall-page-click-u-v-pie :uvlist="uvPieList" class="top-margin15"/>
...
<script>
  import HallPageClickTable from "./hallpageclick/HallPageClickTable";
  import HallPageClickPVPie from "./hallpageclick/HallPageClickPVPie";
  import HallPageClickUVPie from "./hallpageclick/HallPageClickUVPie";
  export default {
    name: "HallPageUser",
    components:{HallPageClickTable,HallPageClickPVPie,HallPageClickUVPie},
    data() {
      return {
        query: {
          page: 1,
    ...
    methods: {
      ...
      async getDataList() {
        const res = await this.$http.get(`/hbydGame/gameVisit/getListDayCountPvUv?page=${this.query.page}&limit=${this.query.limit}`)
        ...
        for(var i=0; i < res_data.length;i++ ){
          ...
          countRateArray.push([res_data[i].countDayTime, res_data[i].countOrderRate]);
        ...
        this.tableOrderList=countOrderArray
        this.tableRateList=countRateArray
