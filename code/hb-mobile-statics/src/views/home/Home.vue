      ...
      <el-row>
        <el-col :span="8">
          <el-card class="no-border">
            <span>当前筛选时间总订购量:{{this.totalOrder}}</span>
          </el-card>
        </el-col>
        <el-col :span="8">
          <el-card class="no-border">
            <span>当前筛选时间总PV:{{this.totalPV}}</span>
          </el-card>
        </el-col>
        <el-col :span="7">
          <el-card class="no-border">
            <span>当前筛选时间总UV:{{this.totalUV}}</span>
          </el-card>
        </el-col>
      </el-row>
      <div class="stat-container top-margin15">
        <div class="visit">
          <!--          <day-visit-chart-->
  ...
  export default {
    ...
    methods: {
      ...
      processOrderData(res) {
        ...
        console.log(typeof countUserOrderArray);
