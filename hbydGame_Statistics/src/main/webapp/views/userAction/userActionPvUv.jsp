...
<form class="layui-form" id="search-form" >
	...
	<script type="text/javascript">
		...
		//			,type:'datetime'
			...
			table.render({
				...
				url : 'userAction/getListPvUvByPage',
	...
	//				dataJson[res_data[i].gameName] = res_data[i].countPV;
					countPVArray.push([res_data[i].countDay, res_data[i].countPV]);
					countUVArray.push([res_data[i].countDay, res_data[i].countUV]);
				}
				//设置PV UV数据
			...
			function createCirclePvOrigin(res){
				...
				console.info("22222222222222222222222222222222222222222222");
			...
			$("#export-button").click(function () {
				var url ='userAction/getListPvUvExport.do';
