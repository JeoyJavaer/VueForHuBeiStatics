...
<form class="layui-form" id="search-form" >
	...
	<table class="layui-hide" id="gameCountTable"
		lay-filter="gameCountTable"></table>
	...
	<script type="text/javascript">
		...
		//			dataJson[res_data[i].gameName] = res_data[i].countPV;
					countPVArray.push([res_data[i].gameName+" / "+res_data[i].packageName+" / "+res_data[i].countDayTime, res_data[i].countPV]);
					countUVArray.push([res_data[i].gameName+" / "+res_data[i].packageName+" / "+res_data[i].countDayTime, res_data[i].countUV]);
				}
			...
			$("#export-button").click(function () {
				var url ='count/gamelistExport.do';
