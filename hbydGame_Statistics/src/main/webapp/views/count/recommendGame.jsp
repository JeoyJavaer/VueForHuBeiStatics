...
<form class="layui-form" id="search-form">
	<div class="layui-form" style="width: 100%; margin-top: 20px;">
		<blockquote class="layui-elem-quote quoteBox">
			...
			<label style="margin-left: 10px;" class="layui-label">推荐位名称</label>
			<div style="width: 100px;" class="layui-inline">
				<input type="text" name="recName" lay-verify="required"
					style="width: 100%;" placeholder="" autocomplete="off"
					class="layui-input" />
			</div>
	...
	<table class="layui-hide" id="recommendGameTable"
		lay-filter="recommendGameTable"></table>
	...
	layui.use([ 'table', 'form', 'laydate'], function() {
		...
		table.render({
			elem : '#recommendGameTable',
			url : 'recommendGame/getListByPage',
		//	toolbar: 'default' ,
		/* 
			defaultToolbar: [
				'filter', 
		 ...
		 */	
			...
			cols : [ [ 
				 ...
				 */
				{
					...
					field : 'recClickTimeFmt',
					title : '创建时间',
					align : 'center',
					width : 200,
					templet : function(data) {
						return data.recClickTimeFmt;
					}
				}
			] ],
			loading : true //分页加载样式
		...
		var active = {
			reload : function() {
				...
				//执行重载
				table.reload('recommendGameTable', {
					page : {
						curr : 1
					//重新从第 1 页开始
					},
		...
		$("#export-button").click(function () {
			var url ='recommendGame/getListExport.do';
